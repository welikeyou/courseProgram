...
public class NodeCachingLinkedList_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Consumer", false, NodeCachingLinkedList_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Predicate", false, NodeCachingLinkedList_ESTest_scaffolding.class.getClassLoader()));
  }
