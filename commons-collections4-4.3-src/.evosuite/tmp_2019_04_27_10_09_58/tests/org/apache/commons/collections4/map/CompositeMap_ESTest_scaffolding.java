...
public class CompositeMap_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.AbstractMap$SimpleEntry", false, CompositeMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, CompositeMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiConsumer", false, CompositeMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, CompositeMap_ESTest_scaffolding.class.getClassLoader()));
  }
