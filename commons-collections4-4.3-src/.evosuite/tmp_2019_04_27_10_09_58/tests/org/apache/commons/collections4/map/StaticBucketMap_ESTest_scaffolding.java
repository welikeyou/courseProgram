...
public class StaticBucketMap_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.ThreadGroup", false, StaticBucketMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, StaticBucketMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiConsumer", false, StaticBucketMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, StaticBucketMap_ESTest_scaffolding.class.getClassLoader()));
  }
