...
public class AbstractHashedMap_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, AbstractHashedMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, AbstractHashedMap_ESTest_scaffolding.class.getClassLoader()));
  }
