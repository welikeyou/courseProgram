...
public class AbstractReferenceMap_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, AbstractReferenceMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, AbstractReferenceMap_ESTest_scaffolding.class.getClassLoader()));
  }
