...
public class ZippingIterator_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Iterator", false, ZippingIterator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, ZippingIterator_ESTest_scaffolding.class.getClassLoader()));
  }
